...
namespace ChileSystems.DTE.Engine.RespuestaEnvio
{
    /// <summary>
    ...
    public class RespuestaDTE
    {
        ...
        public string Firmar(string nombreCertificado, string password = "")
        {
            ...
            var content = SIMPLE_API.Security.Firma.Firma.FirmarDocumentoPath(filePath, Resultado.Id.ToString(), nombreCertificado, password);
            return filePath;
        }
    }
}
