...
namespace ChileSystems.DTE.WS.EstadoDTE
{
    public static class EstadoDTE
    {
        ...
        public static EstadoDTEResult GetEstado(int rutConsultante, string dvConsultante, int rutEmpresa, string dvEmpresa, int rutReceptor, string dvReceptor, int TipoDTE, int FolioDTE, DateTime FechaDTE, long MontoDTE, string nombreCertificado, AmbienteEnum ambiente, string tokenFullPath, out string error, string password = "")
        {
            try
            {
                string message = "";
                ...
                {
                    SIMPLE_API.Produccion.EstadoDTE.QueryEstDteService query = new SIMPLE_API.Produccion.EstadoDTE.QueryEstDteService();
                ...
                {
                    SIMPLE_API.Certificacion.EstadoDTE.QueryEstDteService query = new SIMPLE_API.Certificacion.EstadoDTE.QueryEstDteService();
                    response = query.getEstDte(rutConsultante.ToString(),
                        dvConsultante,
                        rutEmpresa.ToString(),
                        dvEmpresa,
        ...
        public static EstadoDTEResult GetEstadoBoleta(int rutEmpresa, string dvEmpresa, int rutReceptor, string dvReceptor, int TipoDTE, int FolioDTE, DateTime FechaDTE, long MontoDTE, string nombreCertificado, AmbienteEnum ambiente, string tokenFullPath, out string error, string password = "")
        {
            try
            {
                string message = "";
