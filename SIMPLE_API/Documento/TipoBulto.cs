...
namespace ChileSystems.DTE.Engine.Documento
{
    public class TipoBulto
    {
        ...
        public SIMPLE_API.Enum.CodigosAduana.TipoBultoEnum CodigoTipoBulto { get; set; }
        public bool ShouldSerializeCodigoTipoBulto() { return CodigoTipoBulto != SIMPLE_API.Enum.CodigosAduana.TipoBultoEnum.NotSet; }
        /// <summary>
        /// Cantidad de Bultos
        /// </summary>
