...
namespace ChileSystems.DTE.Engine.Documento
{
    public class Extranjero
    {
        ...
        public SIMPLE_API.Enum.CodigosAduana.Paises Nacionalidad { get; set; }
        public bool ShouldSerializeNacionalidad() { return Nacionalidad != SIMPLE_API.Enum.CodigosAduana.Paises.NotSet; }

        public Extranjero()
        {
            Id = string.Empty;
            Nacionalidad = SIMPLE_API.Enum.CodigosAduana.Paises.NotSet;
        }
    }
}
