using ChileSystems.DTE.Engine.CAFHandler;
using ChileSystems.DTE.Engine.Documento;
using ChileSystems.DTE.Engine.PDF417;
...
namespace SIMPLE_API.Documento
{
    ...
    public class Exportaciones
    {
        ...
        /// </summary>
        [XmlIgnore]
        public DateTime FechaHoraFirma { get { return DateTime.Parse(FechaHoraFirmaString); } set { FechaHoraFirmaString = value.ToString(ChileSystems.DTE.Engine.Config.Resources.DateTimeFormat); } }
