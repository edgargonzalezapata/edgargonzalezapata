...
namespace ChileSystems.DTE.Engine.Documento
{
    public class Totales
    {
        ...
        public SIMPLE_API.Enum.CodigosAduana.Moneda TipoMoneda { get; set; }
        public bool ShouldSerializeTipoMoneda() { return TipoMoneda != SIMPLE_API.Enum.CodigosAduana.Moneda.NotSet; }
        ...
        public Totales()
        {
            TipoMoneda = SIMPLE_API.Enum.CodigosAduana.Moneda.NotSet;
            MontoTotal = 0;
            MontoNeto = 0;
            MontoExento = 0;
