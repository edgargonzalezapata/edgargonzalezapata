...
namespace ChileSystems.DTE.Engine.Documento
{
    ...
    public class Documento
    {
        ...
        public bool Timbrar(string _CAFFilePath, out string message)
        {
            ...
            TED.DatosBasicos.FechaTimbre = this.Encabezado.IdentificacionDTE.FechaEmision;
        ...
        public bool Timbrar(Autorizacion autorizacion, out string message, bool escribeArchivo = false, string tempFilePath = "out\\temp\\")
        {
            message = string.Empty;
            DateTime dateTimeStamp = DateTime.Now;            
            TED = new TimbreElectronico();
            TED.DatosBasicos = new DatosBasicos();
            TED.DatosBasicos.CAF = autorizacion.CAF;
            TED.DatosBasicos.DescripcionPrimerDetalle = this.Detalles.FirstOrDefault().Nombre;
            TED.DatosBasicos.FechaTimbre = this.Encabezado.IdentificacionDTE.FechaEmision;
            TED.DatosBasicos.FechaEmision = this.Encabezado.IdentificacionDTE.FechaEmision;
            TED.DatosBasicos.FolioDTE = this.Encabezado.IdentificacionDTE.Folio;
            ...
            try {
                ...
                TED.Firmar(autorizacion, escribeArchivo, tempFilePath);
            }
            catch(Exception ex) 
            {
                message = ex.Message;
        ...
        public bool TimbrarNoFile(Autorizacion autorizacion, out string message)
        {
            message = string.Empty;
            DateTime dateTimeStamp = DateTime.Now;            
            TED = new TimbreElectronico();
