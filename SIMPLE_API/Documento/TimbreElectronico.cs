...
namespace ChileSystems.DTE.Engine.Documento
{
    ...
    public class TimbreElectronico
    {
        ...
        internal void Firmar(string _CAFFilePath)
        {
            //this.DatosBasicos.CAF.Datos.RazonSocialEmisor = SecurityElement.Escape(this.DatosBasicos.CAF.Datos.RazonSocialEmisor);
            string xml = XML.XmlHandler.SerializeCAF<DatosBasicos>(DatosBasicos, XML.SerializationType.SerializationTypes.Inline);
            //xml = xml.Replace("", "O&quot;H");
            ...
            this.FirmaDigital.Firma = SIMPLE_API.Security.Timbre.Timbre.Timbrar(xml, privateKey);
            //this.DatosBasicos.CAF.Datos.RazonSocialEmisor = SecurityElement.Escape(this.DatosBasicos.CAF.Datos.RazonSocialEmisor);
            //this.DatosBasicos.CAF.Datos.RazonSocialEmisor = this.DatosBasicos.CAF.Datos.RazonSocialEmisor.Replace("&quot;", "\"");
        }
        
        internal void Firmar(Autorizacion autorizacion, bool escribeArchivo = false, string tempFilePath = "out\\temp\\")
        {
            //this.DatosBasicos.CAF.Datos.RazonSocialEmisor = SecurityElement.Escape(this.DatosBasicos.CAF.Datos.RazonSocialEmisor);
            ...
            string privateKey = autorizacion.ClavePrivadaRSA;
        ...
        internal void FirmarNoFile(Autorizacion autorizacion)
        {
            var message = "";
            //this.DatosBasicos.CAF.Datos.RazonSocialEmisor = SecurityElement.Escape(this.DatosBasicos.CAF.Datos.RazonSocialEmisor);
            var xml = XML.XmlHandler.SerializeNoFile<DatosBasicos>(DatosBasicos, XML.SerializationType.SerializationTypes.Inline, out message, true, null);
            //xml = xml.Replace("O\"H", "O&quot;H");
            string privateKey = autorizacion.ClavePrivadaRSA;
        ...
        internal void Firmar(string xml, string privateKey)
        {
            //this.DatosBasicos.CAF.Datos.RazonSocialEmisor = SecurityElement.Escape(this.DatosBasicos.CAF.Datos.RazonSocialEmisor);
            //string xml = XML.XmlHandler.SerializeCAF<DatosBasicos>(DatosBasicos, XML.SerializationType.SerializationTypes.Inline);
            //xml = xml.Replace("O\"H", "O&quot;H");
        ...
        {
            string privateKey = CAFHandler.CAFHandler.GetPrivateKey(_CAFFilePath);
            //SIMPLE_API.Security.Timbre.Timbre.VerificarTimbre(xml, _CAFFilePath, )
        }
