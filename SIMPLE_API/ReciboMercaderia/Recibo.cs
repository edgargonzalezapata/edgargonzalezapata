...
namespace ChileSystems.DTE.Engine.ReciboMercaderia
{
    /// <summary>
    ...
    public class Recibo
    {
        ...
        public string Firmar(string nombreCertificado)
        {
            ...
            var content = SIMPLE_API.Security.Firma.Firma.FirmarDocumentoPath(filePath, this.DocumentoRecibo.Id, nombreCertificado);
            return filePath;
        }
    }
}