...
namespace SIMPLE_API.Cesion
{
    public class DocumentoCesion
    {
        ...
        [XmlIgnore]
        public DateTime UltimoVencimiento { get { return DateTime.Parse(UltimoVencimientoString); } set { UltimoVencimientoString = value.ToString(ChileSystems.DTE.Engine.Config.Resources.DateFormat); } }
        ...
        [XmlIgnore]
        public DateTime TmstCesion { get { return DateTime.Parse(TmstCesionString); } set { TmstCesionString = value.ToString(ChileSystems.DTE.Engine.Config.Resources.DateTimeFormat); } }


        public DocumentoCesion(ChileSystems.DTE.Engine.Documento.DTE dteCedido, int secuencia)
        {
