...
namespace SIMPLE_API.Cesion
{
    public class Caratula
    {
        ...
        [XmlIgnore]
        public DateTime TmstFirmaEnvio { get { return DateTime.Parse(TmstFirmaEnvioString); } set { TmstFirmaEnvioString = value.ToString(ChileSystems.DTE.Engine.Config.Resources.DateTimeFormat); } }
