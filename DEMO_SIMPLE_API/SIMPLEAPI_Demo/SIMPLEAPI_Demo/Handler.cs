...
namespace SIMPLEAPI_Demo
{
    public class Handler
    {
        ...
        public DTE GenerateDTEsibb(TipoDTE.DTEType tipoDTE, DateTime FechaEmision, int folio, string idDTE = "")
        {
            // DOCUMENTO
            var dte = new DTE();
            //
        ...
        public string TimbrarYFirmarXMLDTE(DTE dte, string pathResult, string pathCaf, out string messageOut)
        {
            ...
            return dte.Firmar(DateTime.Now ,configuracion.Certificado.Nombre, out messageOut, "out\\temp\\", "");
        }
