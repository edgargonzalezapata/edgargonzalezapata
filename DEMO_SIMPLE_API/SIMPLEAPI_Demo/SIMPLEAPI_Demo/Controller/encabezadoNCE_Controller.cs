...
namespace SIMPLEAPI_Demo.Controller
{
    ...
    internal class encabezadoNCE_Controller
    {
        public string sql;
        ...
        public DataSet GetNCE(ref DateTime inicio, ref DateTime termino)
        {
            variablesGlobales objvariablesGlobales = new variablesGlobales();
            try
            {
